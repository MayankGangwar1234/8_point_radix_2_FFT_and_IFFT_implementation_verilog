    ...
    always @ (*) begin
        ...
        if (~signal) begin
            if (in1==16'b0 && in2==16'b0) begin
                ...
                if (mantissa_addition==12'b0) begin
                    op = 16'b0;
                end
                else begin
...
module fft_8point (
    ...
    always @(*) begin
        ...
        if (real_in0[14:10]==5'd31 || real_in1[14:10]==5'd31 || real_in2[14:10]==5'd31 || 
            real_in3[14:10]==5'd31 || real_in4[14:10]==5'd31 || real_in5[14:10]==5'd31 ||
            real_in6[14:10]==5'd31 || real_in7[14:10]==5'd31 || imag_in0[14:10]==5'd31 || 
            imag_in1[14:10]==5'd31 || imag_in2[14:10]==5'd31 || imag_in3[14:10]==5'd31 || 
            imag_in4[14:10]==5'd31 || imag_in5[14:10]==5'd31 || imag_in6[14:10]==5'd31 || 
            real_in7[14:10]==5'd31) begin
            invalid_input = 1'b1;
        end
        else if (fftorifft==1) begin
            for (j = 0; j < 8; j = j + 1) begin
                if (real_out[j][14:10]!=5'b0) begin
                    div_real[j] = real_out[j][14:10];
                    real_outz[j] = div_real[j] - minus[j];
                end

                if (imag_out[j][14:10]!=5'b0) begin
                    div_imag[j] = imag_out[j][14:10];
                    imag_outz[j] = div_imag[j] - minus[j];
                end
            end
